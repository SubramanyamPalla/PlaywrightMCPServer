...
test('Scroll down and up on the page and verify elements', async ({ page }) => {
  ...
  // Step 5: Scroll up to top
  await automationExercise.clickScrollUpArrow();

  // Step 6: Verify 'Full-Fledged practice website for Automation Engineers' text is visible
